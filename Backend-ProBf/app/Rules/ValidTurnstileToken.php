 ...
 * deux cas elle-même.
 *
 * $implicit = true : sans ça, Laravel n'exécute pas les règles sur un
 * champ vide ou absent, et un jeton vide passerait silencieusement —
 * exactement l'état initial du champ côté frontend avant que le widget
 * Turnstile ne réponde.
 */
