...
class TwoFactorAuthController extends Controller
{
     ...
     * frontend la transforme en QR code lui-même (package `qrcode` côté
     * React) : l'API ne rend aucune image, elle ne fait que fournir la donnée.
     */
     ...
     * une seule fois dans cette réponse — l'API ne les renvoie jamais en clair
     * ensuite (voir regenerateRecoveryCodes pour en obtenir de nouveaux).
     */
     ...
     * invalides) : mot de passe requis, comme pour disable(), puisque ça
     * invalide silencieusement l'ancien filet de sécurité de l'utilisateur.
     */
    ...
    /**
     * Étape 2 du login (voir AuthController::login) : consomme le jeton
     * temporaire émis à la place du token final quand la 2FA est active, avec
     * soit un code TOTP soit un code de récupération à usage unique.
     */
    public function challenge(Request $request)
    {
        ...
        // Jeton à usage unique : qu'il ait servi ou non à un second essai,
        // il ne doit pas rester valide pour de futures tentatives.
